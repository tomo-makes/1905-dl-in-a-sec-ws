...
- 仕事で機械学習・深層学習を使う助けとなること
  - アイデアに対し、具体的な実現方法がイメージできる＝効く収益向上・コスト削減施策をうてる（顧客も社内も）
  - できないことは、できないと分かる＝だまされない、時間の無駄を減らす
  - 何ができ、何ができないのか知る、継続してアップデートする
...
- 機械学習そのもの、ではなくその使い方にスポットをあてたい
- 言い方を変えるなら、「虫の目」に加えて「鳥の目、魚の目」
  - **虫の目** DAY1, 2は数式、ピースを積み上げ、一定の理解を得た
  - **鳥の目** 少しひいて、俯瞰図・全体像を見る
  - **魚の目** 移り変わり、トレンドを見る
...
- 数式で挫折 = Colabで
- 環境ステップアップで挫折 = PaaS紹介
- 定期的な情報収集で挫折 = 情報ソースを示す

---

### 地図2 - Why, What, How

異なる抽象度を意識して、想像・行動できるようになる。

- Why
	- ○○という領域の課題
	- ○○というAIで、病気に診断が飛躍的に進歩することが期待
- What
	- ○○モデルで、画像診断の正解率がx%まで向上
- How
  - ○○の新規手法で○○を達成、○○の課題は残る
  - GitHubに公開される実行可能なコード、データセット
